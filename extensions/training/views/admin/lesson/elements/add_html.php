...
<div id="modal_add_html" class="uk-modal">
    <div class="uk-modal-dialog uk-modal-add-elem">
        <div class="userbox modal-userbox-3">
            <form enctype="multipart/form-data" action="/admin/training/lessons/element/add" method="POST">
                ...
                <input type="hidden" name="element_type" value="<?=TrainingLesson::ELEMENT_TYPE_HTML?>">

                <div class="modal-admin_top">
                    <h3 class="modal-traning-title"><span class="modal-traning-title-icon"><img width="22" src="/extensions/training/web/admin/images/icons/html.svg" alt=""></span>Добавить код</h3>
                    ...
                    <div class="row-line">
                        <div class="col-1-1">
                            <div class="width-100"><label>Произвольный html-код</label>
                                <textarea class="html-code" name="params[html]" rows="3" cols="40"></textarea>
                            </div>
                        </div>
