                            ...
                            <div class="blog_item">
                                ...
                                <div class="intro">
                                    ...
                                    <div class="post_info">
                                        ...
                                        <?php if($params['params']['show_cat'] == 1 && $post['rubric_id'] != 0):?>
                                        ...
                                        <?php if($post['author_id'] != null):?>
                                            <span class="small"><?=System::Lang('AUTHOR');?> <?php $author_data = User::getUserNameByID($post['author_id']); echo $author_data['user_name'];?></span>
                                        <?php endif;?>
                                    </div>
                                    <?=$post['intro'];?>
                                </div>
