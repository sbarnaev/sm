...
<div class="main">
    ...
    <form action="" method="POST">
        <div class="admin_top admin_top-flex">
            ...
            <ul class="nav_button">
                <li><input type="submit" name="addmethod" value="Создать" class="button save button-white font-bold"></li>
        ...
        <div class="admin_form">
            <div class="row-line">
                <div class="col-1-2">
                    <h4>Основное</h4>
                    <p class="width-100"><label>Название способа: </label><input type="text" name="name" placeholder="Название" required="required"></p>
                    ...
                    <p class="width-100"><label>Описание:</label><textarea name="ship_desc" rows="3" cols="40"></textarea></p>
                ...
                <div class="col-1-2">
                    <h4>Дополнительно</h4>
                    <p class="width-100"><label>Стоимость:</label><input type="text" name="tax"></p>
